  ...
  return (
    <View style={styles.home}>
      ...
      <Component3
        ...
        component3Top={0}
        component3Left={0}
        onComponent3Press={() => navigation.navigate("Home8")}
      />
      <Pressable
...
213510362 (2134)`}</Text>
      <View style={[styles.homeChild2, styles.homeChildLayout4]} />
      ...
      <View style={[styles.homeChild4, styles.homeChild4Layout]} />
      <Pressable
        style={[styles.rectanglePressable, styles.homeChild4Layout]}
        onPress={() => navigation.navigate("Home13")}
      />
